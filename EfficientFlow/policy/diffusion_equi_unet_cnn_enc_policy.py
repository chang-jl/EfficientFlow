...
class DiffusionEquiUNetCNNEncPolicy(BaseImagePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor],preaction=None,i=None) -> Dict[str, torch.Tensor]:
        """
        ...
        action_to_compare=action_pred[ : ,end-1:end-1+8]#7-11
    ...
    def compute_loss(self, batch,epoch=None,mean_score=0):
