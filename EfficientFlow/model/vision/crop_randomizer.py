...
import EfficientFlow.model.common.tensor_util as tu
...
class CropRandomizer(nn.Module):
    ...
    def __init__(
        ...
        print("CropRandomizer input_shape: ", input_shape,"crop_height: ", crop_height,"crop_width: ", crop_width,"num_crops: ", num_crops,"pos_enc: ", pos_enc)
